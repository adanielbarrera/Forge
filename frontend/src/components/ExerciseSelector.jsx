                    ...
                    <div className="grid grid-cols-1 gap-2">
                        {filteredExercises.map(ex => (
                            <button
                                ...
                                className="flex items-center justify-between p-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-transparent hover:border-white/10 transition-all text-left group"
                            >
                                <div>
